...
class Transaction(models.Model):
    ...
    order_id = models.CharField(max_length=255, unique=True, null=True, blank=True, help_text="Generic Internal Order ID")
    ...
    khalti_purchase_order_id = models.CharField(max_length=255, null=True, blank=True)
    ...
    def __str__(self):
        return f"Tx: {self.order_id} ({self.payment_method}) - {self.status}"
