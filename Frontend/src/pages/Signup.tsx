        ...
        >
          <div className="backdrop-blur-3xl bg-white/70 dark:bg-slate-900/40 rounded-[32px] p-8 md:p-10 border border-white/60 dark:border-white/5 shadow-[0_32px_80px_-20px_rgba(0,0,0,0.08)] transition-all">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button type="button" className="flex items-center justify-center space-x-2 py-2.5 bg-white dark:bg-white/5 border border-slate-200/50 dark:border-white/5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/10 transition-all duration-300 shadow-sm active:scale-95 group">
